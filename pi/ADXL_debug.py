#imports made according to the requirements.txt file in this directory
...
"""
A lightweight ADXL345 Sensor Class to efficiently handle sensor data using interrupts/polling.

Written by: Paranjay Lokesh Chaudhary
During IITGN SRIP'25

> Currently work has stopped on this to focus on the Arduino Nano 33 BLE Sense, as interrupts and i2c were found to be 
  unreliable for current use case.

> This will be branched to create a full-fledged sensor library in the future.

To-Do:

No tasks remaining; finished as of 22/05/25

Consult sensor_checklist.py to observe changes made to this program, by function.
